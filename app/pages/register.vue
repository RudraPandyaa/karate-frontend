...
const selectedCountry = computed(() => {
  return getCountry(country.value)
})

const phoneCode = computed(() => {
  return selectedCountry.value?.phoneCode || '+91'
})

const flagUrl = computed(() => {
  return getFlagUrl(country.value)
})
...
async function handleRegister() {
  ...
  try {
    ...
    if (registerAsAthlete.value) {
      ...
      body.middleName =
        middleName.value.trim() || undefined
      ...
      >
        ...
        <div>
          ...
          <p class="mt-1 text-xs text-white/45">
            Additional information required for athlete registration
          </p>
        </div>
        ...
        <div>
          ...
          >
            ...
            <div
              class="flex shrink-0 items-center border-r border-white/10 px-4"
            >
              <span
          ...
          <p class="mt-1.5 text-xs text-white/40">
            Only 10 digits. Country code changes automatically.
          </p>
        </div>
