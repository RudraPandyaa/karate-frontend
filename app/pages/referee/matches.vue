...
function showScore(m: { status: string }) {
  return ['IN_PROGRESS', 'PAUSED', 'COMPLETED'].includes(m.status)
}
</script>
...
<template>
  <div class="mx-auto max-w-5xl space-y-6 p-6">
    ...
    <div v-else-if="error" class="rounded-xl border border-red-500/40 bg-red-500/10 p-4 text-red-300">
      {{ error }}
    </div>
