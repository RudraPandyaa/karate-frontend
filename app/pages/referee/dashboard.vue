...
<template>
  <div class="space-y-6 p-6">
    <div>
      <h1 class="text-2xl font-bold text-foreground">Referee Dashboard</h1>
    ...
    <template v-else>
      ...
      <div class="rounded-xl border border-line bg-surface p-5">
        ...
        <div v-else class="mt-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
